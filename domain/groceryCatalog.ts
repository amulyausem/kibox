...
export const GROCERY_CATALOG: CatalogEntry[] = [
  ...
  entry('Almond milk', 'dairy', ['almond'], { unit: 'carton', shelfLifeDays: 10 }),
  entry('Half and half', 'dairy', ['cream'], { unit: 'carton', shelfLifeDays: 7 }),
  entry('Cottage cheese', 'dairy', [], { unit: 'tub', shelfLifeDays: 10 }),
  entry('Mozzarella', 'dairy', [], { unit: 'pack', shelfLifeDays: 14 }),
  entry('Strawberries', 'produce', ['berries'], { unit: 'box', shelfLifeDays: 4 }),
  entry('Blueberries', 'produce', [], { unit: 'box', shelfLifeDays: 7 }),
  entry('Carrots', 'produce', [], { unit: 'bag', shelfLifeDays: 14 }),
  entry('Broccoli', 'produce', [], { unit: 'head', shelfLifeDays: 6 }),
  entry('Onions', 'produce', ['onion'], { location: 'pantry', unit: 'bag', shelfLifeDays: 21 }),
  entry('Garlic', 'produce', [], { location: 'pantry', unit: 'head', shelfLifeDays: 30 }),
  entry('Potatoes', 'produce', ['potato'], { location: 'pantry', unit: 'bag', shelfLifeDays: 21 }),
  entry('Lettuce', 'produce', ['romaine'], { unit: 'head', shelfLifeDays: 6 }),
  entry('Bell peppers', 'produce', ['pepper'], { unit: 'pcs', shelfLifeDays: 7 }),
  entry('Limes', 'produce', ['lime'], { unit: 'pcs', shelfLifeDays: 14 }),
  entry('Oranges', 'produce', ['orange'], { unit: 'pcs', shelfLifeDays: 14 }),
  entry('Grapes', 'produce', [], { unit: 'bag', shelfLifeDays: 7 }),
  entry('Chicken breast', 'meat', [], { unit: 'pack', shelfLifeDays: 2 }),
  entry('Turkey', 'meat', [], { unit: 'pack', shelfLifeDays: 3 }),
  entry('Bacon', 'meat', [], { unit: 'pack', shelfLifeDays: 7 }),
  entry('Tofu', 'meat', [], { unit: 'pack', shelfLifeDays: 7 }),
  entry('Tortillas', 'pantry', [], { location: 'other', unit: 'pack', shelfLifeDays: 14 }),
  entry('Black beans', 'pantry', ['beans'], { unit: 'can', shelfLifeDays: 365 }),
  entry('Chickpeas', 'pantry', [], { unit: 'can', shelfLifeDays: 365 }),
  entry('Soy sauce', 'pantry', [], { unit: 'bottle', shelfLifeDays: 365 }),
  entry('Ketchup', 'pantry', [], { unit: 'bottle', shelfLifeDays: 180 }),
  entry('Mayonnaise', 'pantry', ['mayo'], { unit: 'jar', shelfLifeDays: 90 }),
  entry('Honey', 'pantry', [], { unit: 'jar', shelfLifeDays: 365 }),
  entry('Cereal', 'pantry', [], { unit: 'box', shelfLifeDays: 90 }),
  entry('Bagels', 'pantry', [], { location: 'other', unit: 'pack', shelfLifeDays: 5 }),
  entry('Frozen pizza', 'frozen', [], { unit: 'box', shelfLifeDays: 90 }),
  entry('Frozen broccoli', 'frozen', [], { unit: 'bag', shelfLifeDays: 180 }),
  entry('Laundry detergent', 'household', ['detergent'], { location: 'other', unit: 'bottle', shelfLifeDays: 365 }),
  entry('Toilet paper', 'household', [], { location: 'other', unit: 'pack', shelfLifeDays: 365 }),
];
